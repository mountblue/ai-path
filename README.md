...
* While using models - use models with a lower token use instead of a higher one - like Claude Sonnet (instead of Claude Opus which uses more tokens) or the Google Gemini (medium). Tokens are usually refreshed every 5 hours. If you use tokens fast, you will have to wait for sometime.
...
The above courses will cover some concepts from the below two sections - Understanding LLMs and Building Agents & Skills.

## Understanding LLMs

- Overview - Andrej Karpathy's playlist - Almost 6 hours - [https://www.youtube.com/playlist?list=PLAqhIrjkxbuW9U8-vZ_s_cjKPT_FqRStI](https://www.youtube.com/playlist?list=PLAqhIrjkxbuW9U8-vZ_s_cjKPT_FqRStI)
